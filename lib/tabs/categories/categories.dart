          ...
          Row(
            children: [
              ...
              CustomButtons.customOutlineButton(
                ...
                bgColor: Theme.of(context).primaryColor,
                foregroundColor: Colors.white,
                onPressed: () => CustomDialogs.openResponsiveDialog(context, widget: const CategoryForm(category: null)),
              ),
            ],
          ),
          categories.isEmpty
          ...
          child: Row(
            ...
            children: [
              InkWell(
                ...
                onTap: () => CustomDialogs.openResponsiveDialog(context, widget: CategoryForm(category: d)),
              ),
              const SizedBox(
                width: 5,
              ),
              InkWell(
                ...
                onTap: () => CustomDialogs.openActionDialog(
                  ...
                  message: 'Do you want to add this category to the featured section?',
