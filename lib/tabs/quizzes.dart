...
class Quizzes extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Quizzes> createState() => _QuizzesState();
}

class _QuizzesState extends ConsumerState<Quizzes> {
      ...
      body: CardWrapper(
        child: FirestoreQueryBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot, _) {
            ...
            DataTableSource source = QuizDataSource(context, quizList, ref);
            return Padding(
    ...
    return Padding(
      ...
      child: TextButton.icon(
        ...
        onPressed: () => CustomDialogs.openResponsiveDialog(
          context,
          widget: const QuizForm(quiz: null),
  ...
  Widget _setOrderButton() {
    return InkWell(
      onTap: () => CustomDialogs.openResponsiveDialog(context, widget: const SetQuizOrder()),
      child: Container(
        height: 40,
        padding: const EdgeInsets.only(left: 20, right: 20),
