    ...
    if (hasAdminAccess(ref)) {
      if (formKey.currentState!.validate()) {
        ...
        if (await controller.getText() != '') {
          ...
          await NotificationService().sendCustomNotificationByTopic(titleCtrl.text, description, _targetUsers);
          await FirebaseService().saveNotification(_notification(description));
