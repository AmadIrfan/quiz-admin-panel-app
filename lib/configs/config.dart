...
class Config {
  //Your App Name
  static const String appName = 'SERU Test';

  //Firebase Cloud Messaging Server Token for Push Notifications
  static const String firebaseServerToken = 'AAAAkpWhmw0:APA91*************';
  ...
  final double defaultChildAspectRatio = 2.0;
